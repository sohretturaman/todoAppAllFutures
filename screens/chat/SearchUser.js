  ...
  return (
    <View style={{padding: 2, flex: 1}}>
      <SearchComp
        ...
        value={search}
      />
      <Text style={{padding: 2}}> Recent Searches </Text>
      ...
      {/**try to give recommendations about users, with location,with mutual friends  */}
      ...
      {!search&&(
          <View
            ...
            <ScrollView>
              <Text style={{fontSize: 16, padding: 10, color: 'gray'}}>
                {' '}
